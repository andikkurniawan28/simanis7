...
@section("form-create")
    <form action="{{ route("pot.store") }}" method="POST">
        @csrf @method("POST")
                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $pot->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "keterangan")) }} : {{ $pot->keterangan }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("pot.destroy", $pot->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
