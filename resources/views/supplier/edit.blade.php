...
@section("form-create")
    <form action="{{ route("supplier.update", $supplier->id) }}" method="POST">
        ...
        <div class="d-flex flex-column mb-7 fv-row">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="" name="keterangan" value="{{ $supplier->keterangan }}" required/>
        </div>
        ...
        <div class="d-flex flex-column mb-7 fv-row">
            ...
            <input type="{{ $type[$i] }}" class="form-control form-control-solid" placeholder="" name="{{ $var[$i] }}" value="{{ $supplier->{$var[$i]} }}" required/>
        </div>
        @endfor
