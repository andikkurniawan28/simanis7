            ...
            <div class="col">
                <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <select name="ppn" class="form-control">
                        <option disabled selected value> -- select an option -- </option>
                        <option value="Y" @if($stock->ppn == 'Y') {{ "selected" }} @endif >Ya</option>
            ...
            <div class="col">
                <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <select name="status" class="form-control">
                        <option disabled selected value> -- select an option -- </option>
                        <option value="Y" @if($stock->status == 'Y') {{ "selected" }} @endif >Ya</option> >Ya</option>
                        <option value="T" @if($stock->status == 'T') {{ "selected" }} @endif >Tidak</option>
                    </select>
                </div>
            </div>
            <div class="col"></div>
