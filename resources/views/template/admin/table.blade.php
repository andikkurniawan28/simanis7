...
<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--end::Export-->
                            <!--begin::Tambah customer-->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Tambah @yield("title")</button>
                            <!--end::Tambah customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">@yield("title") Name</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            <tr>
                                ...
                                <img src="/metronic/dist/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9163</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="/metronic/dist/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 7063</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="/metronic/dist/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8458</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <img src="/metronic/dist/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6409</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="/metronic/dist/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 3153</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="/metronic/dist/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9239</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="/metronic/dist/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5344</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="/metronic/dist/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6049</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="/metronic/dist/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 6123</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="visa">
                                <img src="/metronic/dist/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 5182</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="mastercard">
                                <img src="/metronic/dist/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8096</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
                            ...
                            <tr>
                                ...
                                <!--begin::Payment method=-->
                                <td data-filter="american_express">
                                <img src="/metronic/dist/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9156</td>
                                <!--end::Payment method=-->
                                <!--begin::Date=-->
            ...
            <!--end::Card-->
            <!--begin::Modals-->
            <!--begin::Modal - @yield("title") - Tambah-->
            <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../demo7/dist/apps/customers/list.html">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_customer_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">Tambah a @yield("title")</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div id="kt_modal_add_customer_billing_info" class="collapse show">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="required fs-6 fw-bold mb-2">Tambahress Line 1</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-bold mb-2">Tambahress Line 2</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">Export @yield("title")</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
