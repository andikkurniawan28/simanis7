                ...
                <td>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                            <a href="{{ route("sub_golongan.edit", $sub_golongan->id) }}" class="menu-link px-3">{{ ucwords("edit") }}</a>
                        </div>
                        <div class="menu-item px-3">
                            <form action="{{ route("sub_golongan.destroy", $sub_golongan->id) }}" method="POST" id="form-delete">
                                @csrf @method("DELETE")
