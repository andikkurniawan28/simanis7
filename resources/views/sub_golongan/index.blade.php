...
@section("form-create")
    <form action="{{ route("sub_golongan.store") }}" method="POST">
        @csrf @method("POST")
                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $sub_golongan->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "keterangan")) }} : {{ $sub_golongan->keterangan }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("sub_golongan.destroy", $sub_golongan->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
