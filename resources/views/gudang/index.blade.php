                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $gudang->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "keterangan")) }} : {{ $gudang->keterangan }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "omzet")) }} : {{ $gudang->omzet }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "jual")) }} : {{ $gudang->jual }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kodesc")) }} : {{ $gudang->kodesc }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("gudang.destroy", $gudang->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
