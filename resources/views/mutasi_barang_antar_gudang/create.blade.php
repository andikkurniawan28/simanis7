...
@section("form-create")
    ...
    <form action="{{ route("mutasi_barang_antar_gudang.store") }}" method="POST">
        @csrf @method("POST")
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                    ...
                    <select name="nodo" class="form-control">
                        ...
                        @foreach ($order_mutasi_barang_antar_gudangs as $order_mutasi_barang_antar_gudang)
                            <option value="{{ $order_mutasi_barang_antar_gudang->kode }}">{{ $order_mutasi_barang_antar_gudang->faktur }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
