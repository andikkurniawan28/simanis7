                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $wilayah->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "keterangan")) }} : {{ $wilayah->keterangan }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="modal-dialog mw-650px">
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                <form action="{{ route("wilayah.update", $wilayah->kode) }}" method="POST">
                                    @csrf @method("PUT")
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="" name="kode" value="{{ $wilayah->kode }}" required/>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder="" name="keterangan" value="{{ $wilayah->keterangan }}" />
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("wilayah.destroy", $wilayah->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
