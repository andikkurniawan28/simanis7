...
@section("form-create")
    <form action="{{ route("golongan.store") }}" method="POST">
        ...
        <div class="d-flex flex-column mb-7 fv-row">
            ...
            <input type="number" step="any" class="form-control form-control-solid" placeholder="" name="ppn" value="" />
        </div>
                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $golongan->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "keterangan")) }} : {{ $golongan->keterangan }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "ppn(%)")) }} : {{ $golongan->ppn }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="mb-10">
                                <form action="{{ route("golongan.update", $golongan->kode) }}" method="POST">
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <input type="number" step="any" class="form-control form-control-solid" placeholder="" name="ppn" value="{{ $golongan->ppn }}" />
                                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("golongan.destroy", $golongan->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
