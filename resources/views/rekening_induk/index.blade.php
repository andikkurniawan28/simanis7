    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="example">
        ...
        @foreach ($rekening_induks as $rekening_induk)
            <tr>
                ...
                <td>{{ $rekening_induk->rekening_balance_income->nama ?? "" }}</td>
            </tr>
                            ...
                            <div class="mb-10">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "kode")) }} : {{ $rekening_induk->kode }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "nama")) }} : {{ $rekening_induk->nama }}
                                    </li>
                                    <li class="list-group-item">
                                        {{ ucwords(str_replace("_", " ", "rekening_balance_income")) }} : {{ $rekening_induk->rekening_balance_income->nama ?? "" }}
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="mb-10">
                                ...
                                <form action="{{ route("rekening_induk.destroy", $rekening_induk->kode) }}" method="POST">
                                    @csrf @method("DELETE")
                                    <div class="text-center pt-0">
