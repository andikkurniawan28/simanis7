...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $termins = [
            [ "kode" => "000", "keterangan" => "TUNAI", "lama" => 0	],
            [ "kode" => "003", "keterangan" => "3 HARI", "lama" => 3	],
            [ "kode" => "007", "keterangan" => "7 HARI", "lama" => 7	],
            [ "kode" => "014", "keterangan" => "14 HARI", "lama" => 14	],
            [ "kode" => "030", "keterangan" => "30 HARI", "lama" => 30	],
            [ "kode" => "045", "keterangan" => "45 HARI / 1.5 BULAN", "lama" => 45	],
            [ "kode" => "060", "keterangan" => "60 HARI", "lama" => 60	],
