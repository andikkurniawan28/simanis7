...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $mata_uangs = [
            ["kode" => "IDR", "kurs" => 1, "keterangan" => NULL, "tanggal" => "2012-07-31" ],
            ["kode" => "USD", "kurs" => 9000, "keterangan" => NULL, "tanggal" => "2012-07-31" ],
            ["kode" => "IDR", "kurs" => 9000, "keterangan" => NULL, "tanggal" => "2013-01-01" ],
            ["kode" => "USD", "kurs" => 9700, "keterangan" => NULL, "tanggal" => "2013-01-01" ],
            ["kode" => "USD", "kurs" => 12200, "keterangan" => NULL, "tanggal" => "2013-12-20" ],
            ["kode" => "IDR", "kurs" => 1, "keterangan" => NULL, "tanggal" => "2022-08-27" ],
            ["kode" => "IDR", "kurs" => 1, "keterangan" => NULL, "tanggal" => "2023-06-21" ],
            ["kode" => "USD", "kurs" => 15000, "keterangan" => NULL, "tanggal" => "2023-06-21" ],
            ["kode" => "USD", "kurs" => 15001, "keterangan" => NULL, "tanggal" => "2023-06-20" ],
        ];
